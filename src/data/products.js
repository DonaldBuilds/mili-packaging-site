...
export const productCatalog = {
  'rigid-gift-boxes': [
    ...
    },
    {
      ...
      price: '5.54',
      tierPrice: { 100: '5.54', 1000: '3.32', 5000: '1.12' },
    ...
    {
      slug: 'luxury-magnetic-folding-gift-box',
      name: 'Luxury Magnetic Folding Gift Box',
      tagline: 'Rigid-feel magnetic box with custom insert',
      spec: 'Foldable rigid board, magnetic closure, custom EVA/foam insert',
      price: '0.49',
      img: '/assets/images/mig-luxury-magnetic-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-luxury-magnetic-box-2.webp', '/assets/images/mig-luxury-magnetic-box-3.webp', '/assets/images/mig-luxury-magnetic-box-4.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Foldable rigid magnetic box with custom insert'], ['Material', 'Greyboard / coated board, FSC-certified options'], ['Finish', 'Matte or gloss lamination, gold/silver foil, embossing, UV'], ['Insert', 'Custom EVA / foam / flocked tray with precision cutouts'], ['Structure', 'Flip-top magnetic lid, auto-lock base, ships flat'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A foldable rigid magnetic box that delivers the heft of a premium presentation case while shipping flat. The flip-top lid closes with a magnetic snap and the base holds a custom-cut insert with precision cutouts for your product.',
        'Built for electronics, cosmetics, jewelry and corporate gifting - anywhere the unboxing has to feel premium and the freight budget has to stay sane.',
        'Mili manufactures it in-house with FSC-certified board options, custom EVA or flocked trays, and gold or silver foil finishing. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from 100 pcs.',
      ],
      chips: ['Magnetic Closure', 'Foldable Rigid', 'Custom Insert', 'Gold Foil', 'Flocked Tray', 'FSC Board'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - structure, size, material, finishing and quantity. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
      ...
      industry: { to: '/industries/electronics-tech', text: 'Magnetic presentation boxes with custom inserts for electronics and premium retail.' },
      faq: [
        ['What is the minimum order for this magnetic box?', 'MOQ is just 100 pcs - ideal for testing a new SKU or a limited edition. Volume discounts apply from 1,000 pcs.'],
        ['Can the insert be customized to fit my product exactly?', 'Yes. We produce a custom EVA, foam or flocked tray from your product drawings, with free structural samples before bulk production.'],
        ['Is the box really foldable?', 'Yes - it ships flat with the lid and base pre-scored, then snaps into shape with an auto-lock base and magnetic lid. No glue or tape needed.'],
        ['Which materials and finishes are available?', 'Greyboard or coated board with matte or gloss lamination, gold/silver foil stamping, embossing, spot UV and soft-touch options. FSC-certified board on request.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
      ],
    },
    {
      slug: 'luxury-cookie-rigid-box',
      name: 'Luxury Cookie Bakery Rigid Box',
      tagline: 'One-piece rigid box for cookies & bakery',
      spec: 'One-piece rigid board, full-color print, matte finish',
      price: '1.96',
      tierPrice: { 100: '2.40', 1000: '1.96', 5000: '1.18' },
      img: '/assets/images/mig-cookie-rigid-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-cookie-rigid-box-2.webp', '/assets/images/mig-cookie-rigid-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'One-piece rigid box with printed interior'], ['Material', 'Greyboard + art paper, FSC-certified options'], ['Printing', 'Full-color CMYK + Pantone, inside and outside'], ['Finish', 'Matt lamination, gold foil, embossing'], ['Food-Safe', 'Food-grade inks and boards available'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A one-piece rigid gift box for cookies and bakery treats, built from thick greyboard with a full-color printed interior so the unboxing moment looks as good as the product tastes. The rigid structure keeps biscuits, macarons and cake slices protected and presentable.',
        'Built for bakeries, patisseries, food brands and corporate gifting programs that sell premium confectionery - retail shelf display, holiday collections and gifting boxes that have to feel substantial.',
        'Mili manufactures it in-house with food-safe board and ink options, FSC-certified paper, free design support and a 3D mockup within 48 hours. MOQ from 100 pcs with factory-direct pricing and AQL 2.5 QC on every batch.',
      ],
      chips: ['Full-Color Print', 'Rigid Structure', 'Food-Safe', 'Custom Size', 'Recyclable', 'FSC Paper'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - structure, size, material, finishing and quantity. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
      ...
      industry: { to: '/industries/food-beverage', text: 'Rigid bakery gift boxes with food-safe full-color print for patisseries and gifting brands.' },
      faq: [
        ['What is the minimum order for this bakery box?', 'MOQ is just 100 pcs - ideal for testing a seasonal collection or a limited run. Volume discounts apply from 1,000 pcs.'],
        ['Is the box food-safe?', 'Yes. We offer food-grade boards and inks, and all materials can be FSC-certified on request.'],
        ['Can I print my branding inside and outside?', 'Yes - full-color CMYK and Pantone printing on both interior and exterior, plus matte lamination, gold foil or embossing for the finish.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
        ['What is the lead time for bulk production?', 'Standard bulk lead time is 12-15 days after artwork approval, plus shipping (FOB, CIF or DDP door-to-door).'],
      ],
    },
  ...
  'cosmetic-boxes': [
    ...
    {
      slug: 'valentine-magnetic-folding-box',
      name: 'Valentine Magnetic Folding Box',
      tagline: 'Ribbon-tied foldable magnetic box for seasonal gifting',
      spec: 'Foldable magnetic lid, satin ribbon tie, matte finish',
      price: '0.49',
      img: '/assets/images/mig-valentine-magnetic-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-valentine-magnetic-box-2.webp', '/assets/images/mig-valentine-magnetic-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Foldable magnetic gift box, ribbon slot closure, flat-pack'], ['Material', 'FSC-certified paperboard, custom colors'], ['Finish', 'Matte lamination, hot stamping, glitter, embossing, UV options'], ['Structure', 'Collapsible magnetic box, ships flat, pops into shape'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A foldable magnetic gift box with a satin ribbon tie and a clean matte finish. It ships and stores flat, then snaps into shape with a magnetic closure - the ribbon slips through the front slot to finish the look.',
        'Made for Valentines, wedding, party and seasonal campaigns - cosmetic sets, jewelry, chocolate or small gifts that deserve a keepsake presentation without rigid-box freight costs.',
        'Mili prints your artwork in full color with matte lamination, hot stamping, glitter, embossing or UV options on FSC-certified board. Free design support, a 48-hour 3D mockup and MOQ from just 100 pcs.',
      ],
      chips: ['Foldable Design', 'Magnetic Closure', 'Satin Ribbon Tie', 'Matte Lamination', 'Flat-Pack Shipping', 'Seasonal Ready'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - size, ribbon color, printing and quantity. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/beauty-skincare', text: 'Foldable magnetic gift boxes for seasonal beauty and skincare sets.' },
      faq: [
        ['What is the minimum order?', 'MOQ is just 100 pcs - low enough to test a holiday or Valentines run without over-committing.'],
        ['How does a foldable magnetic box work?', 'It ships flat with the magnetic flaps pre-assembled. You lift the sides into shape and the lid closes with a magnetic snap - no glue or tape needed.'],
        ['Can the ribbon color match my brand?', 'Yes - the ribbon, box color and finish are all customizable to your brand palette, and we can print your logo on the lid or ribbon.'],
        ['What materials and finishes are available?', 'FSC-certified paperboard in any custom color, with matte or gloss lamination, hot stamping, glitter, embossing, spot UV and 3D effects.'],
        ['How much freight does flat-pack save?', 'A flat-fold box takes roughly 70% less shipping and storage space than a pre-erected box, which usually cuts your freight cost per unit significantly.'],
      ],
    },
  ],
  'jewelry-boxes': [
    ...
    {
      slug: 'jewelry-drawer-organizer-box',
      name: 'Jewelry Drawer Organizer Box',
      tagline: 'Sleeve-and-drawer jewelry gift box with velvet insert',
      spec: 'Drawer sleeve box, velvet insert, custom foil',
      price: '0.63',
      img: '/assets/images/mig-jewelry-drawer-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-jewelry-drawer-box-2.webp', '/assets/images/mig-jewelry-drawer-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Outer sleeve + sliding drawer box'], ['Material', 'Textured paperboard, FSC-certified options'], ['Interior', 'Velvet / foam insert with precision slits'], ['Finish', 'Gold foil, hot stamping, custom print'], ['Structure', 'Drawer slides out with ribbon pull'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A sleeve-and-drawer jewelry box with a textured finish and a soft velvet insert. The drawer slides out with a gentle pull to reveal rings, earrings or necklaces cradled in precision-cut slits.',
        'For jewelry brands, bridal and gift shops that want an affordable keepsake box with a premium slide-out ritual.',
        'Mili customizes the box color, foil logo and insert layout to fit each piece. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from just 100 pcs.',
      ],
      chips: ['Drawer Slide', 'Velvet Insert', 'Foil Logo', 'Textured Paper', 'Anti-Tarnish Option', 'Low MOQ'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - box size, insert layout and branding. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/fashion-apparel', text: 'Drawer-style jewelry boxes for retail, bridal and boutique gifting.' },
      faq: [
        ['What is the minimum order?', 'MOQ is just 100 pcs - ideal for testing a design or a limited collection before scaling.'],
        ['Can the insert be customized for my jewelry?', 'Yes. We cut the velvet or foam insert to the exact shape of your rings, earrings or necklaces, with free structural samples before bulk.'],
        ['Which colors and finishes are available?', 'Any custom color on textured paperboard, with gold foil, hot stamping or full print. Anti-tarnish fabric options available.'],
        ['Can I mix ring and necklace sizes in one box?', 'Yes - the insert layout is fully customizable, so one box can hold different piece types in a single program.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
      ],
    },
    {
      slug: 'jewelry-set-drawer-box',
      name: 'Jewelry Set Drawer Box',
      tagline: 'Damask-patterned drawer box for jewelry sets',
      spec: 'Patterned sleeve box, suede pouch, ribbon pull',
      price: '0.60',
      img: '/assets/images/mig-jewelry-set-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-jewelry-set-box-2.webp', '/assets/images/mig-jewelry-set-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Patterned sleeve + sliding drawer set'], ['Material', 'FSC-certified paperboard, textured paper options'], ['Interior', 'Suede / velvet pouch with ribbon pull'], ['Finish', 'Gold foil logo, matte lamination, embossing'], ['Structure', 'Square drawer box, stock 5x5x3.5cm and 7.5x7.5x3.5cm plus custom'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A damask-patterned drawer box finished with gold-foil branding and a matching suede pouch. Bags, boxes and pouches coordinate into one elegant presentation for rings, earrings and small pieces.',
        'For jewelry brands and boutiques building a cohesive unboxing identity across multiple product lines.',
        'Mili prints the pattern and foil on FSC-certified board and lines the drawer in suede or velvet. Free design support, 2 rounds of free structural samples and MOQ from 100 pcs.',
      ],
      chips: ['Damask Pattern', 'Gold Foil', 'Suede Pouch', 'Drawer Slide', 'Coordinated Set', 'FSC Board'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - pattern, size and branding. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/fashion-apparel', text: 'Coordinated patterned jewelry boxes for retail and boutique gifting.' },
      faq: [
        ['What is the minimum order?', 'MOQ is 100 pcs - low enough to launch a coordinated jewelry line or a seasonal set.'],
        ['Can I use my own pattern or artwork?', 'Yes. Send your pattern or brand artwork and we print it in full color with gold foil, or design a custom pattern for you, free.'],
        ['What sizes are available?', 'Stock square sizes 5x5x3.5cm and 7.5x7.5x3.5cm, plus fully custom dimensions.'],
        ['What is inside the drawer?', 'A suede or velvet pouch with ribbon pull - the pouch protects the piece while the box presents the brand.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
      ],
    },
    {
      slug: 'book-style-jewelry-gift-box',
      name: 'Book-Style Jewelry Gift Box',
      tagline: 'Book-shaped jewelry box with hidden drawer',
      spec: 'Book-shaped rigid box, drawer closure, embossed logo',
      price: '0.30',
      img: '/assets/images/mig-book-jewelry-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-book-jewelry-box-2.webp', '/assets/images/mig-book-jewelry-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Book-shaped box with pull-out drawer'], ['Material', 'Greyboard, FSC-certified options'], ['Finish', 'Embossed / foil logo, custom color'], ['Interior', 'Cardboard or velvet lining'], ['Structure', 'Reusable book-style presentation'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A book-shaped jewelry box with a hidden pull-out drawer and an embossed or foil-stamped logo. The spine conceals the opening, so the reveal feels like a secret.',
        'For wedding, bridal and gift markets where the packaging itself is part of the present - rings, earrings and small keepsakes.',
        'Mili builds it from greyboard with a cardboard or velvet lining and custom foil or embossing. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from 100 pcs.',
      ],
      chips: ['Book Shape', 'Hidden Drawer', 'Embossed Logo', 'Greyboard', 'Reusable', 'Gift-Ready'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - size, lining and branding. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/fashion-apparel', text: 'Book-style jewelry boxes for wedding, bridal and gift retail.' },
      faq: [
        ['What is the minimum order?', 'MOQ is just 100 pcs - ideal for a wedding collection or a boutique launch.'],
        ['How does the drawer open?', 'The box looks like a closed book. Pull the spine or the drawer edge and the inner tray slides out to reveal the jewelry.'],
        ['Can the drawer hold different jewelry types?', 'Yes - the drawer insert is cut to fit rings, earrings, pendants or small watches, depending on your product.'],
        ['What materials and finishes are available?', 'Greyboard construction with cardboard or velvet lining, and embossed, debossed or gold-foil logos in any custom color.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
      ],
    },
    {
      slug: 'drawer-sliding-jewelry-box',
      name: 'Drawer-Sliding Jewelry Box',
      tagline: 'Magnetic drawer box with velvet-lined interior',
      spec: 'Magnetic closure drawer box, velvet lining, full print',
      price: '0.65',
      img: '/assets/images/mig-drawer-sliding-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-drawer-sliding-box-2.webp', '/assets/images/mig-drawer-sliding-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Magnetic sleeve + sliding drawer'], ['Material', 'Coated paperboard, FSC-certified options'], ['Interior', 'Velvet / flocked insert'], ['Finish', 'Gold foil logo, full-color print'], ['Structure', 'Drawer slide with magnetic closure'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A drawer-sliding jewelry box with a magnetic closure and a velvet-lined interior. The sleeve-and-drawer construction keeps the piece secure in transit while the magnetic snap adds a premium click.',
        'For jewelry brands and seasonal collections - necklaces, rings, earrings and bracelets - that want a complete branded set with matching bags, boxes and cards.',
        'Mili prints your branding in gold foil across the box, bag and cards, and lines the drawer in velvet. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from 100 pcs.',
      ],
      chips: ['Magnetic Closure', 'Drawer Slide', 'Velvet Lining', 'Gold Foil', 'Full Set', 'Seasonal'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - size, print and quantity. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/fashion-apparel', text: 'Magnetic drawer jewelry boxes with coordinated branded sets.' },
      faq: [
        ['What is the minimum order?', 'MOQ is 100 pcs - perfect for a seasonal collection or a first branded launch.'],
        ['Why a magnetic closure on a drawer box?', 'The magnetic snap keeps the drawer shut during shipping and adds a reassuring premium feel when it clicks open.'],
        ['Can you theme the set for a holiday?', 'Yes - box color, print, ribbon and card wording can all match a Valentine, Christmas or bridal theme.'],
        ['What materials are used?', 'Coated paperboard on FSC-certified stock, with velvet or flocked interior and gold-foil branding.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
      ],
    },
  ],
  'watch-boxes': [
    ...
    {
      slug: 'modern-luxury-single-watch-box',
      name: 'Modern Luxury Single Watch Box',
      tagline: 'Rectangular watch box with cushioned pillow',
      spec: 'Rigid box, cushioned pillow, matte or gloss finish',
      price: '4.90',
      tierPrice: { 100: '6.32', 1000: '4.90', 5000: '3.72' },
      img: '/assets/images/mig-modern-watch-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-modern-watch-box-2.webp', '/assets/images/mig-modern-watch-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Lid & base premium watch box'], ['Material', 'Coated board with recycled material options'], ['Interior', 'Suede / velvet lining with cylindrical pillow'], ['Finish', 'Matte lamination, gold foil, UV, embossing'], ['Structure', 'Fits case diameters up to 50mm'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A rectangular single watch box with a cushioned pillow and a clean matte or gloss finish. The watch rests on the pillow with the strap wrapped around, protected by a soft-lined lid.',
        'For watch brands, retailers and pre-owned dealers who need premium single-piece presentation at a sensible price.',
        'Mili builds it on coated board with recycled material options, suede or velvet lining and gold-foil branding. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from 100 pcs.',
      ],
      chips: ['Watch Pillow', 'Suede Lining', 'Gold Foil', 'Matte Lamination', 'Recycled Options', 'Custom Size'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - case diameter, lining and branding. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/fashion-apparel', text: 'Premium single watch boxes for watch retail and gifting.' },
      faq: [
        ['What is the minimum order?', 'MOQ is 100 pcs - lower than typical watch-box minimums, so boutiques and dealers can start small.'],
        ['What watch sizes does the pillow fit?', 'The cylindrical pillow fits case diameters up to about 50mm, with custom pillow sizes available on request.'],
        ['Which materials and finishes are available?', 'Coated board with recycled material options, suede or velvet lining, and matte or gloss lamination with gold foil, UV or embossing.'],
        ['Can I add a drawer or window?', 'Yes - optional compartments, drawers and display windows can be added to the base structure.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
      ],
    },
    {
      slug: 'drawer-style-watch-gift-box',
      name: 'Drawer-Style Watch Gift Box',
      tagline: 'Magnetic drawer watch box with ribbon and handle',
      spec: 'Drawer box, magnetic closure, ribbon + handle, cushioned insert',
      price: '5.60',
      tierPrice: { 100: '7.22', 1000: '5.60', 5000: '4.26' },
      img: '/assets/images/mig-drawer-watch-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-drawer-watch-box-2.webp', '/assets/images/mig-drawer-watch-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Drawer-style watch gift box'], ['Material', 'Cardboard, recycled & FSC-certified options'], ['Interior', 'Cushioned insert, suede / velvet options'], ['Finish', 'Matte lamination, gold foil, UV, embossing'], ['Accessories', 'Magnetic closure, satin ribbon, carry handle'], ['Structure', 'Custom shape for watch retail presentation'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A drawer-style watch box with magnetic closure, satin ribbon and a carry handle. The drawer slides out to reveal a cushioned watch pillow - packaging that works on a shelf and in a shopping bag.',
        'Made for watch retail and gifting, where the box has to protect the watch, present it beautifully and be easy to carry out of the store.',
        'Mili customizes the shape, lining, ribbon and handle to your brand, on recycled and FSC-certified board. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from 100 pcs.',
      ],
      chips: ['Drawer Style', 'Magnetic Closure', 'Satin Ribbon', 'Carry Handle', 'Cushioned Insert', 'Recycled Board'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - shape, lining, ribbon and handle. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/fashion-apparel', text: 'Drawer-style watch boxes for watch retail and gift presentation.' },
      faq: [
        ['What is the minimum order?', 'MOQ is 100 pcs - a low-risk way to equip retail displays or a gifting program.'],
        ['How is the watch held inside?', 'The drawer has a cushioned pillow insert with suede or velvet options that cradles the watch case and strap.'],
        ['Can the shape be customized?', 'Yes - the box shape, drawer depth and lining are all custom, built around your watch dimensions.'],
        ['What accessories can be added?', 'Magnetic closure, satin ribbon, carry handle, window displays and additional compartments.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
      ],
    },
  ],
  'mailer-boxes': [
    ...
    },
    {
      ...
      name: 'Kraft Corrugated Mailer Box',
      tagline: 'Eco kraft mailer with full-color interior print',
      spec: 'Kraft corrugated, printed interior, custom size',
      price: '0.40',
      img: '/assets/images/mig-kraft-mailer-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-kraft-mailer-box-2.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '10–12 days'], ['Configuration', 'Tuck-top / ear-lock kraft mailer'], ['Material', 'Recycled kraft corrugated, biodegradable'], ['Print', 'Full-color inside & out, custom logo'], ['Finish', 'Matte lamination option'], ['Structure', 'Lightweight mailer / gift box hybrid'], ['Sampling', '2 rounds free structural samples; pre-production sample fee credited to bulk order'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A kraft corrugated mailer with a clean natural exterior and full-color print inside. It is strong enough to ship, light enough to save freight, and printed on every interior surface so the unboxing carries your brand.',
        'For DTC brands, subscription services and food or cosmetic companies that want eco-friendly packaging without losing the branded unboxing moment.',
        'Mili prints inside and out with water-based inks on recycled, compostable kraft. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from 100 pcs.',
      ],
      chips: ['Recycled Kraft', 'Full-Color Interior', 'Water-Based Ink', 'Biodegradable', 'Tuck-Top Mailer', 'Custom Size'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - structure, size, material and quantity. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 10-12 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/subscription-dtc', text: 'Printed kraft mailers for subscription and e-commerce unboxing.' },
      faq: [
        ['What is the minimum order?', 'MOQ is 100 pcs - low enough to test a pack design or a seasonal drop.'],
        ['Can you print inside the box?', 'Yes - full-color print on the interior surfaces is the signature look, with a clean kraft or printed exterior.'],
        ['Is the box eco-friendly?', 'Yes - recycled kraft corrugated with water-based inks, compostable and recyclable. FSC-certified board available.'],
        ...
        ['How strong is the box?', 'Kraft corrugated is lightweight but rigid - ideal for cosmetics, apparel, food and electronics up to moderate weights.'],
      ],
    },
    {
      slug: 'custom-logo-small-gift-box',
      name: 'Custom Logo Small Gift Box',
      tagline: 'Kraft mailer-gift box with your logo',
      spec: 'Kraft board, custom logo print, small mailer-gift box',
      price: '0.96',
      tierPrice: { 100: '1.15', 1000: '0.96', 5000: '0.43' },
      img: '/assets/images/mig-custom-logo-small-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-custom-logo-small-box-2.webp', '/assets/images/mig-custom-logo-small-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '10–12 days'], ['Configuration', 'Small-size kraft mailer-gift box with custom logo'], ['Material', 'Kraft board, recycled and biodegradable options'], ['Printing', 'Custom logo - offset, flexo or screen print'], ['Finish', 'Matt lamination, hot stamping, spot UV'], ['Eco-Friendly', 'Water-based inks, fully recyclable'], ['Certification', 'FSC / ISO 9001 / AQL 2.5 QC']],
      copy: [
        'A compact kraft mailer-gift box with your custom logo printed on the front - the budget-friendly way to add branded packaging to small products, subscription inserts and e-commerce orders without paying for a heavy rigid structure.',
        'Built for e-commerce brands, subscription boxes, cosmetics and small accessories where every order ships in a branded touchpoint and freight cost matters.',
        'Mili prints your logo with offset, flexo or screen printing on recycled kraft, with water-based inks and a matte or hot-stamped finish. Free 3D mockup in 48 hours and 2 rounds of free structural samples, MOQ from just 100 pcs.',
      ],
      chips: ['Custom Logo', 'Kraft Material', 'Mailer-Style', 'Small Size', 'Recyclable', 'Low MOQ'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - structure, size, material, finishing and quantity. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 10-12 days.'],
      ...
      industry: { to: '/industries/subscription-dtc', text: 'Branded kraft mailer-gift boxes with custom logo for DTC and subscription brands.' },
      faq: [
        ['What is the minimum order for this box?', 'MOQ is just 100 pcs - ideal for testing a new product line or a limited edition. Volume discounts apply from 1,000 pcs.'],
        ['Can you print my logo?', 'Yes - offset, flexo or screen printing in your brand colors, plus matte lamination, hot stamping or spot UV to finish the front panel.'],
        ['Is the box recyclable?', 'Yes - recycled kraft with water-based inks, fully recyclable and biodegradable. FSC-certified paper available.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
        ['What is the lead time?', 'Standard bulk lead time is 10-12 days after artwork approval, plus shipping (FOB, CIF or DDP door-to-door).'],
      ],
    },
  ],
  'folding-cartons': [
    ...
    {
      slug: 'kraft-ribbon-gift-box',
      name: 'Kraft Ribbon Gift Box',
      tagline: 'Foldable kraft rigid box with satin ribbon',
      spec: 'Foldable kraft rigid board, satin ribbon closure',
      price: '1.20',
      tierPrice: { 100: '1.50', 1000: '1.20', 5000: '0.80' },
      img: '/assets/images/mig-kraft-ribbon-gift-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-kraft-ribbon-gift-box-2.webp', '/assets/images/mig-kraft-ribbon-gift-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '12–15 days'], ['Configuration', 'Foldable rigid box with satin ribbon bow'], ['Material', 'Kraft-look rigid board, recycled options'], ['Finish', 'Satin ribbon in any brand color'], ['Structure', 'Foldable rigid - ships flat, snaps into shape'], ['Customization', 'Any size, color and ribbon tone'], ['Certification', 'FSC / ISO 9001 / AQL 2.5 QC']],
      copy: [
        'A foldable rigid gift box wrapped in a kraft-look finish and tied with a satin ribbon bow - the classic premium gift presentation that still ships flat to keep freight costs down.',
        'Built for fashion and apparel brands, jewelry, cosmetics and boutique retail - any product that benefits from a ceremonial ribbon-tie reveal at a folding-carton price point.',
        'Mili produces the rigid structure in-house, snaps flat for shipping, and ties the ribbon in your brand color. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from just 100 pcs.',
      ],
      chips: ['Satin Ribbon', 'Foldable Rigid', 'Kraft Look', 'Custom Size', 'Premium Feel', 'Recyclable'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - structure, size, material, finishing and quantity. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 12-15 days.'],
      ...
      industry: { to: '/industries/fashion-apparel', text: 'Ribbon-tie kraft gift boxes for fashion, jewelry and boutique retail.' },
      faq: [
        ['What is the minimum order for this box?', 'MOQ is just 100 pcs - ideal for a seasonal collection or a limited run. Volume discounts apply from 1,000 pcs.'],
        ['Does the ribbon come in my brand color?', 'Yes - satin ribbon is available in any color to match your brand identity, tied as a bow on the lid.'],
        ['Is the box really foldable?', 'Yes - it ships flat with pre-scored folds and snaps into a rigid structure in seconds, saving roughly 70% freight space.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
        ['What is the lead time?', 'Standard bulk lead time is 12-15 days after artwork approval, plus shipping (FOB, CIF or DDP door-to-door).'],
      ],
    },
  ],
  'paper-bags': [
    ...
    {
      slug: 'custom-logo-kraft-shopping-bag',
      name: 'Custom Logo Kraft Shopping Bag',
      tagline: 'Premium kraft shopping bag with own logo',
      spec: 'Kraft paper, custom print, rope handles, gusseted',
      price: '0.40',
      tierPrice: { 100: '0.60', 1000: '0.40', 5000: '0.25' },
      img: '/assets/images/mig-logo-kraft-bag-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-logo-kraft-bag-2.webp', '/assets/images/mig-logo-kraft-bag-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '10–12 days'], ['Configuration', 'Gusseted kraft shopping bag with rope handles'], ['Material', 'Kraft paper, customized thickness'], ['Printing', 'Custom logo - offset, silk-screen, flexo or gravure'], ['Finish', 'Hot stamping, lamination, nano UV, 20+ colors'], ['Structure', 'Square-bottom with reinforced base'], ['Certification', 'FSC / ISO 9001 / SGS audited / AQL 2.5 QC']],
      copy: [
        'A premium kraft shopping bag with your logo printed front and center - rope handles, gusseted sides and a reinforced square bottom that carries real weight in a retail environment.',
        'Built for fashion and apparel retailers, boutiques, food and beverage brands and gift shops that hand out branded bags at the counter or in-store checkout.',
        'Mili prints your logo with offset, silk-screen, flexo or gravure printing across 20+ color options, with hot stamping and lamination finishes. Free design support, 3D mockup within 48 hours and MOQ from just 100 pcs.',
      ],
      chips: ['Rope Handles', 'Custom Print', 'Kraft Paper', 'Reinforced Base', 'Gusseted', 'Recyclable'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - size, paper thickness, handle type and print. We reply with a tailored quote and free design within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 10-12 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/fashion-apparel', text: 'Custom-logo kraft shopping bags for retail, fashion and boutique brands.' },
      faq: [
        ['What is the minimum order for these bags?', 'MOQ is just 100 pcs - ideal for testing a new retail program. Volume discounts apply from 1,000 pcs.'],
        ['Can you print my logo?', 'Yes - offset, silk-screen, flexo or gravure printing with 20+ color options, plus hot stamping, lamination and nano UV finishes.'],
        ['What handle options are available?', 'Rope handles as standard, with patch, rivet, ribbon and kraft-weave handle options on request.'],
        ['Are the bags eco-friendly?', 'Yes - recyclable and biodegradable kraft with strong, food-safe adhesives, and FSC-certified paper available on request.'],
        ['What is the lead time?', 'Standard bulk lead time is 10-12 days after artwork approval, plus shipping (FOB, CIF or DDP door-to-door).'],
      ],
    },
  ...
  'corrugated-shipping': [
    ...
    {
      slug: 'colorful-printed-shipping-box',
      name: 'Colorful Printed Shipping Box',
      tagline: 'Custom printed mailer with full-color interior',
      spec: 'Corrugated board, full-color print inside & outside',
      price: '1.96',
      tierPrice: { 100: '2.40', 1000: '1.96', 5000: '1.18' },
      img: '/assets/images/mig-colorful-shipping-box-1.webp',
      moq: '100 pcs',
      extraImgs: ['/assets/images/mig-colorful-shipping-box-2.webp', '/assets/images/mig-colorful-shipping-box-3.webp'],
      specs: [['MOQ', '100 pcs'], ['Lead Time', '10–12 days'], ['Configuration', 'Corrugated mailer with full-color inside-and-outside print'], ['Material', 'Corrugated board, recycled kraft options'], ['Printing', 'Full-color CMYK + Pantone, interior and exterior'], ['Finish', 'Matte or gloss lamination'], ['Eco-Friendly', 'Water-based inks, recyclable'], ['Certification', 'FSC / ISO 9001 / AQL 2.5 QC']],
      copy: [
        'A corrugated shipping box with full-color print on the interior as well as the exterior - so the moment the customer opens the carton, your brand story fills the entire space. The unboxing experience a subscription brand needs, at shipping-box economics.',
        'Built for subscription and DTC brands, cosmetics, food and apparel companies that ship direct to consumers and want every touchpoint on-brand.',
        'Mili prints both surfaces in CMYK or Pantone with water-based inks, on recycled corrugated with matte or gloss lamination. Free 3D mockup in 48 hours, 2 rounds of free structural samples and MOQ from just 100 pcs.',
      ],
      chips: ['Full-Color Interior', 'Custom Print', 'Corrugated', 'Eco-Friendly', 'Custom Size', 'Branded Unboxing'],
      process: [
        ['01', 'Inquiry & Quote', 'Send your brief - size, flute, print and quantity. We reply with a tailored quote and free 3D mockup within 24 hours.'],
        ['02', 'Free Sampling', '2 rounds of free structural samples in 3-5 days. Review, refine and approve before bulk production.'],
        ['03', 'Bulk Production', 'In-house manufacturing with AQL 2.5 QC at every workstation. Standard bulk lead time 10-12 days.'],
        ['04', 'Global Delivery', 'FOB, CIF or DDP door-to-door across 50+ countries, with export-grade packing and tracking.'],
      ],
      industry: { to: '/industries/subscription-dtc', text: 'Full-color printed shipping boxes that turn e-commerce delivery into a branded unboxing.' },
      faq: [
        ['What is the minimum order for this box?', 'MOQ is just 100 pcs - ideal for testing a new subscription or DTC program. Volume discounts apply from 1,000 pcs.'],
        ['Can you print inside and outside?', 'Yes - full-color print on both interior and exterior surfaces for a complete branded experience.'],
        ['Is the box eco-friendly?', 'Yes - recycled corrugated with water-based inks, fully recyclable and biodegradable. FSC-certified board available.'],
        ['Do you offer free samples?', 'Yes - 2 rounds of free structural samples in 3-5 days. Pre-production samples with your artwork are credited to your bulk order.'],
        ['What is the lead time?', 'Standard bulk lead time is 10-12 days after artwork approval, plus shipping (FOB, CIF or DDP door-to-door).'],
      ],
    },
