...
export const posts = [
  {
    ...
    body: [
      ...
      { t: 'p', text: 'The single biggest mistake new brands make is over-ordering on the first run. In 2026 the smart play is modular: start at the supplier\u2019s lowest comfortable MOQ, validate the market, then scale in controlled increments. A factory that quotes MOQ 500 pcs (as Mili does across all structures) lets you test a product line without betting the budget. As volume grows, per-unit cost drops naturally — most suppliers step pricing at 1,000, 3,000 and 10,000 units.' },
