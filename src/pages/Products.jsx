...
const allProducts = [
  ...
  { id: 5, name: 'Premium Perfume Packaging Box', category: 'cosmetic', img: '/assets/images/case-cosmetics.jpg', moq: '500 pcs', leadTime: '15 Days', material: 'Rigid board + satin interior' },
  { id: 6, name: 'Watch Display Gift Box', category: 'jewelry', img: '/assets/images/case-jewelry.jpg', moq: '200 pcs', leadTime: '12 Days', material: 'PU leather + velvet cushion' },
  { id: 7, name: 'Eco Kraft Shipping Mailer', category: 'shipping', img: '/assets/images/shipping-box-kraft.jpg', moq: '1000 pcs', leadTime: '10 Days', material: 'FSC-certified kraft corrugated' },
  { id: 8, name: 'Branded Retail Paper Bag', category: 'bags', img: '/assets/images/gift-bag-black.jpg', moq: '500 pcs', leadTime: '12 Days', material: '180g coated art paper' },
];
