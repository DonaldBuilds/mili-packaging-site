...
const industries = [
  {
    ...
    img: '/assets/images/cosmetic-box-black.jpg',
    ...
    caseStudy: { client: 'Aurora Beauty', result: '2,000-unit skincare gift set. Gold foil magnetic box with precision foam inserts. Launched with 180% target sell-through in 3 weeks.' },
  },
  {
    id: 'jewelry',
    ...
    img: '/assets/images/jewelry-box-black.jpg',
    ...
    caseStudy: { client: 'Lumina Jewels', result: 'Matching 3-piece box set (ring/necklace/bracelet) in black with cream velvet and embossed gold logo. 5,000 units. Rated top packaging by retail buyers.' },
  },
  {
    id: 'apparel',
    ...
    img: '/assets/images/gift-bag-black-v2.jpg',
    ...
    caseStudy: { client: 'Vere Apparel', result: 'Eco-kraft mailer boxes with full-color interior brand print. 10,000 units. Reduced return shipping damages by 60% vs. previous plain box.' },
  },
  {
    id: 'food',
    name: 'Food & Beverage',
    ...
    img: '/assets/images/shipping-box-kraft-v2.jpg',
    ...
    caseStudy: { client: 'Nocturne Tea', result: 'Premium tea gift set boxes in kraft with foil stamping. 3,000 units for holiday season. Sold as premium gift product at 3x markup vs. standard packaging.' },
  },
  {
    id: 'electronics',
    name: 'Electronics',
    ...
    img: '/assets/images/mag-box-black-gold.jpg',
    ...
    caseStudy: { client: 'Selene Audio', result: 'Matte black magnetic box with gold foil logo and custom foam insert for wireless earbuds. 8,000 units. Customer unboxing videos organically reached 2M+ views.' },
  },
  {
    id: 'corporate',
    ...
    img: '/assets/images/case-jewelry-v2.jpg',
    ...
    caseStudy: { client: 'Meraki Finance', result: 'Annual client gift set — rigid box with custom branded interior and 3 curated gift items. 1,200 units delivered to 6 countries in 3 weeks. 100% on-time.' },
  },
];
