...
export const cases = [
  ...
  { id:6, client:'Lifestyle Brand (AU)', industry:'Lifestyle', type:'Gift Box + Mailer', finish:'Emboss + Eco Kraft', qty:'4,200 units', leadTime:'10 days', img:'/assets/images/hero-black-gold-v2.jpg', desc:'Home fragrance gift packaging combining a rigid outer gift box with kraft mailer for DTC shipping — dual-layer unboxing experience for subscription boxes.', result:'23% trial-to-paid conversion' },
