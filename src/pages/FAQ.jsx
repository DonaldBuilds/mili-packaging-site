...
const faqData = [
  { cat:'Orders & MOQ', items:[
    { q:'What is your minimum order quantity (MOQ)?', a:'Standard MOQ is 500 pcs for all box types. For first-time or trial orders, contact us — we offer flexible options for startups and new clients.' },
