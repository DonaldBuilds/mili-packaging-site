        ...
        <div className="container" style={{ maxWidth: 860 }}>
          ...
          <div style={{ marginBottom: 64 }}>
            ...
            <div style={{ display:'grid', gap: 2 }}>
              {[
                ['1','Contact Us Within 30 Days','Email milipackaging@163.com with your order number, photos or videos showing the issue, and a description. Most claims are resolved without requiring a physical return.'],
          ...
          <div style={{ padding:'36px', background:'var(--black-2)', border:'1px solid var(--border)', textAlign:'center' }}>
            ...
            <p style={{ color:'var(--gray-3)', marginBottom:28, fontSize:15 }}>Email milipackaging@163.com with your order number and photos. We respond within 48 hours.</p>
            <div style={{ display:'flex', gap:16, justifyContent:'center', flexWrap:'wrap' }}>
              <a href="mailto:milipackaging@163.com" className="btn-gold">Email Returns</a>
