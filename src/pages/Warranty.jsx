        ...
        <div className="container" style={{ maxWidth: 860 }}>
          ...
          <div style={{ marginBottom: 64 }}>
            ...
            <div style={{ display:'grid', gap: 2 }}>
              {[
                ['Step 1','Document the Issue','Within 30 days of delivery, email us at milipackaging@163.com with: photos/videos of the issue, affected quantity, your order number, and a brief description.'],
          ...
          <div style={{ padding:'36px', background:'var(--black-2)', border:'1px solid var(--border)', textAlign:'center' }}>
            ...
            <p style={{ color:'var(--gray-3)', marginBottom:28, fontSize:15 }}>Email us at milipackaging@163.com with your order number and photos of the issue.</p>
